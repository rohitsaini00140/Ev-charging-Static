...
import { allStateData } from "./stateData"
            ...
            {allStateData.length > 0
                ...
                allStateData.map((data, i) => (
                    ...
                    >
                        ...
                        <StyledTableCell>{loading ? <Skeleton sx={{ bgcolor: '#34345a' }} animation="pulse" /> : data.country}</StyledTableCell>
