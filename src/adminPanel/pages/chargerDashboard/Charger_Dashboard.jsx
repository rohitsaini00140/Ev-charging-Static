...
function Charger_Dashboard() {
  const { data: chargerData1, isSuccess: deviceLogSuccess } =
    useGetChargersQuery();

  const allDeviceLogData = Array.isArray(chargerData1) ? chargerData1 : [];

  console.log(allDeviceLogData, "ddddddddd");
  ...
  //   const actions = allDeviceLogData
            ...
            <Grid item size={{ xs: 12, md: 12 }}>
              ...
              >
                ...
                <>
                  ...
                  >
                    <CardContent>
                      <ConnectorStatus  connector={val?.connector_status.flat()}   />
                    </CardContent>
                  </Card>
                </>
