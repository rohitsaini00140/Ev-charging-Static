...
function Footer() {
  ...
  <Typography variant="h6" gutterBottom color="#fff" sx={{textAlign:'center',padding:'30px 0px'}}>
    ...
    <CardContent sx={{padding:'0px'}}>
      ...
      <Box component="form" onSubmit={handleSubscribe} sx={{ display: 'flex', justifyContent: 'right', margin:'10px auto',  width: {
   ...
   <Box
    ...
    />
      ...
      <Typography variant="body2" color="#ffffffd1" sx={{display:'flex',marginTop:'15px'}}>
           <Link color="#fff" sx={{ textDecoration: 'none',marginLeft:'0px', background:'#434e51',width:'25px',height:'25px',borderRadius:'5px',display:'grid',placeItems:'center'}} href="https://www.linkedin.com/company/vrinda-nano-technologies/?originalSubdomain=in" target="_blank" > <LinkedInIcon sx={{fontSize:'18px',"&:hover":{
                color:'#99ff00',
                transition:'0.20s'
              }}} /></Link>
           <Link color="#fff" sx={{ textDecoration: 'none',marginLeft:'15px', background:'#434e51',width:'25px',height:'25px',borderRadius:'5px',display:'grid',placeItems:'center' }} href="#" target="_blank" > <InstagramIcon sx={{fontSize:'18px',"&:hover":{
                color:'#99ff00',
                transition:'0.20s'
              }}} /></Link>
           <Link color="#fff" sx={{ textDecoration: 'none',marginLeft:'15px', background:'#434e51',width:'25px',height:'25px',borderRadius:'5px',display:'grid',placeItems:'center' }} target="_blank"  href="https://www.facebook.com/vrindananotechnologiesvnt"> <FacebookIcon  sx={{fontSize:'18px',"&:hover":{
                color:'#99ff00',
                transition:'0.20s'
              }}} /></Link>
           <Link color="#fff" sx={{ textDecoration: 'none',marginLeft:'15px', background:'#434e51',width:'25px',height:'25px',borderRadius:'5px',display:'grid',placeItems:'center' }} target="_blank"  href="#"> <TwitterIcon sx={{fontSize:'18px',"&:hover":{
                color:'#99ff00',
                transition:'0.20s'
              }}} /></Link>
        </Typography>
         ...
         <Grid container item xs={12} sm={8}>
          <Grid item xs={12} sm={6} md={4} lg={4}>
            ...
            <Typography variant="body2" sx={{margin:'15px 0px'}}>
              <Link sx={{ textDecoration: 'none',"&:hover":{
                color:'#99ff00',
                transition:'0.20s'
              } }} href="#" color="#ffffffd1">
                About Us
          ...
          <Grid item xs={12} sm={6} md={4} lg={4}>
            ...
            <Typography variant="body2" sx={{margin:'15px 0px'}}>
              <Link href="#" color="#ffffffd1" sx={{ textDecoration: 'none',"&:hover":{
                color:'#99ff00',
                transition:'0.20s'
              } }}>
                Privacy Policy
          ...
          <Grid item xs={12} sm={12} md={4} lg={4}>
           ...
           <b>International Address -:</b> <Link color="#ffffffd1" sx={{ textDecoration: 'none' }} href="#">- 3901, 7 Marbelle Avenue Toronto, M9A0C9, Canada</Link>
            ...
            <PhoneIcon sx={{fontSize:'20px',color:'#99ff00'}} /><Link color="#ffffffd1" sx={{ textDecoration: 'none',marginLeft:'5px',"&:hover":{
                color:'#99ff00',
                transition:'0.20s'
